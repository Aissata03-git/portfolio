...
$toEmail = "diarraaissata990@gmail.com"; 
...
$fromEmail = "no-reply@website.com";  
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	---------------------------------------------------*/
	$message = array(
		'recaptcha_invalid' => 'Captcha non validé ! Veuillez réessayer!',
		'recaptcha_error' => 'Captcha non soumis ! Veuillez réessayer.'
	);
	...
	$success = "Merci de nous avoir contactés et je vous recontacterai très prochainement."; // Success Message
